                                ...
                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td align="center" style="padding-bottom:24px;">
                                            <table role="presentation" width="80" height="80" cellspacing="0" cellpadding="0" border="0"
                                                ...
                                                <tr>
                                                    <td align="center" valign="middle">
                                                        ...
                                                        @else
                                                            <span style="display:block;width:80px;height:80px;line-height:80px;font-size:28px;font-weight:700;color:#e0e7ff;text-transform:uppercase;">{{ mb_substr($appName, 0, 1) }}</span>
                                                        @endif
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td style="text-align:center;padding-bottom:12px;">
                                            <h1 style="margin:0;font-size:26px;line-height:1.3;color:#f8fafc;">Olá, {{ $userName }}!</h1>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align:left;padding-bottom:20px;">
                                            <p style="margin:0;font-size:16px;line-height:1.6;color:#f8fafc;">
                                                Recebemos um pedido para redefinir a senha da sua conta <strong style="color:#f8fafc;">{{ $appName }}</strong>.
                                                Para continuar com segurança, clique no botão abaixo. Esse link expira em {{ $expiresInMinutes }} minutos.
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                                <tr>
                                                    <td align="center"
                                                        ...
                                                        <a href="{{ $resetUrl }}"
                                                            style="color:#ffffff;text-decoration:none;font-weight:600;font-size:16px;display:inline-block;">Redefinir senha</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="padding:0 0 18px 0;">
                                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
                                                ...
                                                <tr>
                                                    <td style="padding:16px 20px;font-size:14px;line-height:1.5;color:#cbd5f5;">
                                    ...
                                    <tr>
                                        <td style="padding-top:10px;">
                                            <p style="margin:0;font-size:14px;line-height:1.6;color:#cbd5f5;">
                                                Não foi você? Nenhuma ação é necessária, mas recomendamos alterar sua senha caso note atividade suspeita.
                                                Em caso de dúvidas, responda este e-mail ou fale com nosso suporte:
                                                <a href="mailto:{{ $supportEmail }}" style="color:#a5b4ff;text-decoration:none;">{{ $supportEmail }}</a>.
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align:center;padding-top:32px;">
                                            <p style="margin:0;font-size:13px;line-height:1.4;color:#94a3b8;">&copy; {{ date('Y') }} {{ $appName }}. Todos os direitos reservados.</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
