            ...
            <div class="card-body">
                <form method="POST" action="{{ route('cadastro') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="SENHA_HASH_confirmation" name="SENHA_HASH_confirmation" required>
                    </div>
                    <div class="mb-3">
                        <label for="PERFIL" class="form-label">Perfil</label>
                        <input type="text" class="form-control" id="PERFIL" name="PERFIL" required value="{{ old('PERFIL') }}">
                        @error('PERFIL')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
