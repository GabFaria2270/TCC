            ...
            <div class="form-cadastro-container">
                <div class="form-cadastro">
                    <div class="form-cadastro-card">
                        <div class="form-cadastro-header">Logar</div>
                        <div class="form-cadastro-body">
                            ...
                            <form id="cadastroForm" method="POST" action="{{ route('login') }}">
                                ...
                                <button type="submit" class="form-cadastro-button">Login</button>
                            </form>
                            <div class="login-link">
                                <span>Não tem uma conta?</span>
                                <a href="{{ route('cadastro') }}" class="form-cadastro-link">Cadastrar</a>
                            </div>
                        </div>
                    </div>
                </div>
