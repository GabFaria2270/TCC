...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/js/set.tsx'])
        ...
        <meta name="description" content="Plataforma de gerenciamento de vendas, controle de estoque, PDV online e gestão de clientes para comércio local. Simples, rápida e segura.">
        <meta name="keywords" content="gerenciamento de vendas, controle de estoque, comércio local, gestão de clientes, PDV online, fiado seguro, relatórios de vendas">
        ...
        <meta property="og:description" content="Gerencie vendas, estoque, clientes e fiado em um só lugar com o MaisConectado.">
...
<body class="bg-body-tertiary layout-gerenciamento" data-seo-topics="gerenciamento-de-vendas controle-de-estoque comercio-local gestao-de-clientes pdv-online">
    <noscript>
