                                ...
                                <div className="card-body p-2">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center">
                                        <div className="input-group quantidade-controles w-auto">
                                            ...
                                            <input
                                                type="number"
                                                className="form-control form-control-sm px-0 text-center"
                                                style={{ maxWidth: '48px' }}
                                    ...
                                    <div className="row g-2">
                                        ...
                                        <div className="col-md-3 col-6">
                                            <input
                                                ...
                                                onChange={(e) => setFormaPagamento(e.target.value)}
                                            />
                                            <label className="btn btn-outline-primary d-flex flex-column align-items-center w-100 py-3" htmlFor="pix">
